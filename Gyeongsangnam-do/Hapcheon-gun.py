...
try:
    ...
    format_url = base_url.split("/hc")[0]
    ...
    current_list.append("09272.web")

    page_list = set(current_list) - set(collected_list)

    for page_id in page_list:
        page_url = f"{format_url}/05750/05767/{page_id}"
        driver.get(page_url)
        time.sleep(2)
        ...
        for edit_date in soup.select("#charge1 > div.wrap1 > dl.update > dd"):
