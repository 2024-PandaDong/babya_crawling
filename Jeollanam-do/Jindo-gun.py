...
try:
    ...
    for page_id in page_list:
        ...
        for title in soup.select("#contBody > h2.page_title"):
            data_dict["title"] = title.get_text().strip()
        
        for content in soup.select("div.cont_view"):
        ...
        for edit_date in soup.select("#contSurvey > div.cont_sect > div.page_service > div.srv_foot > ul > li"):
