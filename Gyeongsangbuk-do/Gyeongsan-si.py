...
try:
    ...
    url = f"{format_url}/page.do?mnu_uid=5336&"
    driver.get(url)
    time.sleep(2)
    soup = BeautifulSoup(driver.page_source, 'html.parser')
    
    for i in soup.select("#snb > nav > ul.dept2 > li.on > ul.dept3 > li > a"):
    ...
    for page_id in page_list:
        ...
        for title in soup.select("div.sub_title > div.path > h3"):
        ...
        for edit_date in soup.select("div.sub_info > ul.right > li"):
