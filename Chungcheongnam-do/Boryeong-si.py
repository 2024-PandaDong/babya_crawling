...
try:
    ...
    current_list.append("sub03_01_08.do")
    ...
    for page_id in page_list:
        ...
        styles = []
        elements = soup.select('#contents > ul.h7_ul.ml12 > h4, #contents > ul.h7_ul.ml12 > ul.h7_ul.ml12')
        
        paired_elements = []
        for i in range(0, len(elements), 2):
            if elements[i].name == 'h4' and elements[i + 1].name == 'ul':
        ...
        for title, content in paired_elements:
            # title
