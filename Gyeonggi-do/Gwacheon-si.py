...
try:
    ...
    url = f"{format_url}/contents.do?mId=0601010000"
    driver.get(url)
    time.sleep(2)
    soup = BeautifulSoup(driver.page_source, 'html.parser')
    
    for i in soup.select("ul.snb > li.on > ul > li > a"):
    ...
    for page_id in page_list:
        ...
        for edit_date in soup.select("div.pageInfo > div.dataOffer > div.date > dl > dd"):
