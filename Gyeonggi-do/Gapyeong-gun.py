...
try:
    ...
    url_data = [f"{format_url}/contents.do?key=210", f"{format_url}/contents.do?key=212", f"{format_url}/contents.do?key=1117"]
    ...
    for url in url_data:
        ...
        for i in soup.select("#side > div.side_menu > ul > li.on"):
    ...
    for page_id in page_list:
        ...
        for title in soup.select("div.sub_head > div.sub_title > h1"):
