...
try:
    babya_server = "https://babyaapi.xn--2q1b39m2ui.site"
    region = "106050"
    current_list = list()
    result_data = []
    ...
    url = f"{base_url}?menuCd=DOM_000000404007000000"
    driver.get(url)
    time.sleep(2)
    soup = BeautifulSoup(driver.page_source, 'html.parser')
    
    for i in soup.select("nav.side_menu > ul.depth2_menu > li.actived > ul.depth3_menu > li > a"):
