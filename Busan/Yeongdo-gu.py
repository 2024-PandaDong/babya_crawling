...
try:
    ...
    format_url = base_url.rstrip(".web")
    ...
    url = f"{format_url}/01568/01585/01591.web"
    driver.get(url)
    time.sleep(2)
    soup = BeautifulSoup(driver.page_source, 'html.parser')
    
    for i in soup.select("div.d2 > ul > li.m4.on.hasSub > div.d3 > ul > li > a"):
        id_item = i.get("href").split("01585/")[1]
