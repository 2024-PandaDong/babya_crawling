...
try:
    ...
    url = f"{format_url}/contents.do?key=1408&"
    driver.get(url)
    time.sleep(2)
    ...
    for page_id in page_list:
        ...
        for title in soup.select("header.sub_head > div.sub_head_inner > div.title_box > h2.title"):
        ...
        for edit_date in soup.select("footer.satisfaction > div.satisfaction_list > div.oc_info_box > div.info_box_item > div.info_date_box > span.info_text"):
