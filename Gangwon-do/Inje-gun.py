...
try:
    ...
    # 한 페이지에 정책이 다 있음
    current_list.append("maternalchildhealth")
    ...
    for page_id in page_list:
        ...
        for title in soup.select("#contents > h3"):
        ...
        for content in soup.select("div.contents"):
            ...
            body_content = f"<body><div id='contents' class='pietype subtypebg2'>{content_str}</div></body>"
