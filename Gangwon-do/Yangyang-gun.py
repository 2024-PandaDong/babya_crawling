...
try:
    ...
    current_list.append("service_mchealth")
    ...
    for page_id in page_list:
        ...
        for title in soup.select("#sub_view > div.sub_view_container > strong.tit"):
            data_dict["title"] = title.get_text()
        
        for content in soup.select("#subContainer > div.init_self > div.erms_conts"):
